...
//var url = 'https://api.linkedin.com/v1/people/~:(id, first-name)?format=json';
var profile = { provider: 'linkedin' };

  //**if (this._profileFields) {

  //  console.log(this._profileFields)
    var fields = this._convertProfileFields(this._profileFields);
    url = 'https://api.linkedin.com/v1/people/~:(' + fields + ')?format=json';
    //URL for the parameters of the profile, define in profileFields
...
//URL para posiciones
var url = 'https://api.linkedin.com/v1/people/~:(positions:(id))?format=json';
    this._oauth.get(url, token, tokenSecret, function (err, body, res) {
      if (err) { return done(new InternalOAuthError('failed to fetch user profile', err)); }
